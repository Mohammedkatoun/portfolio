...
<body class="min-h-screen bg-zinc-950 text-zinc-100 antialiased">
    <a href="#content" class="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-50 focus:rounded-xl focus:bg-zinc-900 focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-white focus:ring-2 focus:ring-sky-400">
        Skip to content
    </a>
    ...
    <header class="sticky top-0 z-50 border-b border-white/10 bg-zinc-950/70 backdrop-blur">
        <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
            <a class="group inline-flex items-center gap-3" href="{{ route('home') }}">
                <span class="grid h-10 w-10 place-items-center rounded-2xl bg-gradient-to-br from-sky-400 to-indigo-500 text-zinc-950 shadow-lg shadow-sky-500/20">
    ...
    <footer class="border-t border-white/10 bg-zinc-950">
        <div class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            <div class="grid gap-10 md:grid-cols-2 md:items-start">
                <div>
                    ...
                    <p class="mt-3 max-w-prose text-sm leading-6 text-white/70">
                        Backend Laravel/PHP developer focused on building reliable APIs, clean architectures, and fast web apps.
                    </p>
                </div>
                ...
                <div class="md:text-right">
                    ...
                    <div class="mt-3 inline-flex items-center gap-3">
                        ...
                        <a class="social-link" href="https://twitter.com" target="_blank" rel="noreferrer" aria-label="Twitter">
            ...
            <div class="mt-10 flex flex-col gap-3 border-t border-white/10 pt-8 text-xs text-white/50 md:flex-row md:items-center md:justify-between">
